...
- [Слайды: приветствие, логистика курса, RStudio и базовый синтаксис R](https://appliedepi.github.io/slides/intro/ua/module_1/module_1.html)  

- [Упражнение: настройка R, базовый синтаксис, функции и пакеты](http://exercises.appliedepi.org/app/basics_ua) 
...
- [Упражнение: Управление файлами и импорт данных](http://exercises.appliedepi.org/app/files_import_ua)  
...
- [Слайды: Опрятные данные и очистка данных](https://appliedepi.github.io/slides/intro/ua/module_3/module_3.html)  
  
- [Упражнение: Очистка данных - часть 1](http://exercises.appliedepi.org/app/cleaning_ua)  
...
- [Слайды: Очистка данных часть 2](https://appliedepi.github.io/slides/intro/ua/module_4/module_4.html)  

- [Упражнение: Очистка данных часть 2](http://exercises.appliedepi.org/app/cleaning2_ua)  
...
- [Слайды: Группировка и обобщение данных](https://appliedepi.github.io/slides/intro/ua/module_5/module_5.html)   
  

- [Упражнение: Группировка данных и сводные таблицы](http://exercises.appliedepi.org/app/grouping_summaries_ua)   
...
- [Слайды: Визуализация данных с помощью ggplot2](https://appliedepi.github.io/slides/intro/ua/module_6-1/module_6-1.html)  

- [Упражнение: основы ggplot](http://exercises.appliedepi.org/app/ggplot_basics_ua) 

- [Слайды: Шкалы, темы и метки](https://appliedepi.github.io/slides/intro/ua/module_6-2/module_6-2.html)  

- [Упражнение: Шкалы, темы и ярлыки](https://exercises.appliedepi.org/app/ggplot_scales_themes_ua) 
...
- [Слайды: Объединение данных](https://appliedepi.github.io/slides/intro/ua/module_7-1/module_7-1.html)  
- [Упражнение: Объединение данных](http://exercises.appliedepi.org/app/joining_ua)

- [Слайды: Поворотные данные](https://appliedepi.github.io/slides/intro/ua/module_7-2/module_7-2.html)  

- [Упражнение: Поворот данных](http://exercises.appliedepi.org/app/pivoting_ua) 
...
- [Упражнение: Визуализация данных для общественного здравоохранения](http://exercises.appliedepi.org/app/ggplot_heat_epicurves_pyramids_ua).  
...
- [Слайды: R Markdown и обычные отчеты](https://appliedepi.github.io/slides/intro/ua/module_9/module_9.html)  
  
- [Упражнение: R Markdown](http://exercises.appliedepi.org/app/rmarkdown_ua)  
:::
...
- *Материалы для упражнений*: В папке "intro_course/learning_materials/UKRAINIAN/covid_case_study" вы найдете отчет в формате Word для повторения, наборы данных и лист с советами.  
:::
