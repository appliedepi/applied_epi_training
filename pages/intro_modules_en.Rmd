...
- [Exercise: R setup, basic syntax, functions, and packages](http://exercises.appliedepi.org/app/intro1) 
...
- [Exercise: Cleaning data - part 1](http://exercises.appliedepi.org/app/intro2)  
...
- [Exercise: Cleaning data part 2](http://exercises.appliedepi.org/app/intro3)  
...
- [Exercise: Grouping data and summary tables](http://exercises.appliedepi.org/app/intro4)  
...
- [Exercise: ggplot basics](http://exercises.appliedepi.org/app/intro5_1) 

*Part 2:*  

- [Slides: Scales, themes, and labels](https://appliedepi.github.io/slides/intro/full_text/intro5_2/intro5_2.html)  

- [Exercise: Scales, themes, and lables](https://exercises.appliedepi.org/app/intro5_2)  
...
- [Exercise: R Markdown](http://exercises.appliedepi.org/app/intro6)  
...
- [Exercise: Joining data](http://exercises.appliedepi.org/app/intro7_1)

*Part 2:*  

- [Slides: Pivoting data](https://appliedepi.github.io/slides/intro/full_text/intro7_2/intro7_2.html)  

- [Exercise: Pivoting data](http://exercises.appliedepi.org/app/intro7_2)  
...
- [Exercise: Data visualization for public health](http://exercises.appliedepi.org/app/intro8)  

- GIS demo R script can be found in your course folder at: *"intro_course/ebola/scripts/backup/8_gis_demo.R"*  
...
- [Exercise: COVID-19 exercise](http://exercises.appliedepi.org/app/intro9)
...
In this final module, we teach you how to effectively get help from online forums by creating a "minimal, reproducible example (reprex)" of a coding problem. Working on a new dataset, you will post an R code question in our [Community Forum](http://community.appliedepi.org).  

For this module, we recommend that you bring a dataset from your work to work on. Be aware that you will need to share a small portion (a few rows and columns) of the data publicly on the forum, to demonstrate a coding challenge. We also offer practice datasets that you can use instead.  

- [Slides: ](https://appliedepi.github.io/slides/intro/full_text/intro10/intro10.html)  

- [Exercise: Reprex and next steps](http://exercises.appliedepi.org/app/intro10)
